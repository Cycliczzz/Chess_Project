...
def LoadImages():
    ...
    for piece in pieces:
        images[piece] = p.transform.scale(p.image.load("C:/Users/HP/Documents/GitHub/Chess-project-XD/" + piece +'.png'),(sq_size,sq_size))
    
    for b in buttonList:
        button[b] = p.image.load('C:/Users/HP/Documents/GitHub/Chess-project-XD/image/button.jpg').convert()
